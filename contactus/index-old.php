...
<body>
    ...
    <div class="row">
        ...
        <input class="btn btn-lg" type="submit" name="submit" value="Send" id="form-submit" id="submit" value="Send"/>	
    ...
    <nav id="footer-lrn">
        <div class="container">
            <div class="pull-left fnav">
                 <a class="navbar-brand" href="index.html"><span>Learn</span>Zilla</a>
                <p>ALL RIGHTS RESERVED. COPYRIGHT LearnZilla ©  2017. Designed and Coded by <a href="https://plus.google.com/101363710804618522134/posts/p/pub">Dmitri Tymos</a></p>
            </div>
